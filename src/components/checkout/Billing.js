    ...
    return (
        <React.Fragment>
                ...
                <div className="col-lg-6 col-md-12">
                    <div className="form-group">
                        ...
                        <input
                            ...
                            type="text"
                            name="firstName"
                            className="form-control wd-checkout-input"
                            id="first-name"
                        />
            ...
            <div className="form-group">
                ...
                <textarea
                    onChange={handleOnChange}
                    defaultValue={input.orderNotes}
                    name="orderNotes"
                    className="form-control wd-checkout-textarea"
                    id="order-notes"
                    rows="4"
                />
